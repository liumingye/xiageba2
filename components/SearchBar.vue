...
<template>
  <div class="relative max-w-3xl mx-auto">
    <div class="relative flex items-center">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="absolute left-4 w-5 h-5 text-gray-500" aria-hidden="true">
        <circle cx="11" cy="11" r="8" fill="none" stroke="currentColor" stroke-width="2" />
        <path stroke="currentColor" stroke-width="2" stroke-linecap="round" d="M21 21l-4.3-4.3" />
      </svg>
      <input
        :value="searchQuery"
        type="text"
