...
export class BaiduFSOpenApi {
  ...
  /** 用户信息 */
  userInfo(): Promise<IOpenApiUserInfo> {
    throw "";
  }
  /** 容量信息 */
  quota(): Promise<IOpnApiQuota> {
    throw "";
  }
  xpanfile<Query extends object, Data extends object, Result>(
    method: string,
    query: Query,
    data: Data,
  ): Promise<Result> {
  ...
  xpanmultimedia<Query extends object, Result>(
    method: string,
    query: Query,
  ): Promise<Result> {
    throw "";
  ...
  /** 管理文件 */
  filemanager<Op extends IOpenApiFileManagerOpera>(
    opera: Op,
    param: IOpenApiFileManagerParam<IOpenApiFileManagerFileListTypeMap[Op]>,
  ...
  /** 查询文件信息，包括下载地址 */
  filemetas(param: IOpenApiFileMetasParam): Promise<IOpenApiFileMetasResult> {
    throw "";
  }
  ...
  locateupload(
    path: string,
    uploadid: string,
  ): Promise<IOpenApiLocateUploadResult> {
    throw "";
  }

  /** 预上传 */
  precreate(
    param: IOpenApiPrecreateFileParam,
  ): Promise<IOpenApiPrecreateFileResult> {
    throw "";
  }
  /** 上传完毕创建文件 */
  create(
    param: IOpenApiCreateFileParam | IOpenApiCreateDirParam,
  ): Promise<IFile> {
    throw "";
  }
  /** 上传分片 */
  updatePart(
    param: IOpenApiUpdateParam,
    file: Blob | NodeJS.BufferSource | ReadableStream,
    progress: (event: ProgressEvent) => void,
    serverUrl?: string,
  ): Promise<IOpenApiUpdateResult> {
    throw "";
  }
}
...
BaiduFSOpenApi.prototype.updatePart = async function (
  param,
  file,
  progress,
...
export type IOpenApiFileMetasResult = ResultList<
  IOpenApiFileMeta,
  {
