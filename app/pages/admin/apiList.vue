    ...
    <template #body>
      <div class="space-y-4">
        ...
        <template v-if="form.type === 'api' || form.type === 'pansou'">
          <div class="grid grid-cols-2 gap-4">
            <div>
              <label class="block text-color-400 text-sm mb-1" for="api-method"
                >请求方式</label
              >
              <USelect
                id="api-method"
          ...
          <template v-if="form.type === 'api'">
            <div>
              <label class="block text-color-400 text-sm mb-1" for="api-headers"
                >请求头 (JSON)</label
              >
              <UTextarea
                id="api-headers"
            ...
            <div>
              <label class="block text-color-400 text-sm mb-1" for="api-params"
                >接口参数 (JSON)</label
              >
              <UTextarea
                id="api-params"
        ...
        <template v-else>
          ...
          <div>
            <label class="block text-color-400 text-sm mb-1" for="api-html-type"
              >详情页标签</label
            >
            <UInput
              id="api-html-type"
          ...
          <div>
            <label class="block text-color-400 text-sm mb-1" for="api-html-url2"
              >网盘链接标签</label
            >
            <UInput
              id="api-html-url2"
