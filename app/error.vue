...
useHead({
  title: `${props.error?.status} - ${props.error?.statusText} | ${props.appName}`,
  script: [
    {
...
<template>
  <div
    class="antialiased bg-white dark:bg-black dark:text-white font-sans grid min-h-screen overflow-hidden place-content-center text-black"
